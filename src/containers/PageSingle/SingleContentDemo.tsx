...
const SingleContentDemo = () => {
  return (
    <>
      ...
      <p>
      ABD merkezli Apple, ülkemizde üçüncü mağazasını açmaya hazırlanırken bu mağaza, Avrupa’nın en büyük mağazası olacağı söyleniyor. Hali hazırda İstanbul’un Beşiktaş ve Üsküdar ilçelerinde 2 mağazası bulunan Apple, 3.mağazayı yine İstanbul’da (Bağdat Caddesi) açmaya hazırlanıyor. Ayrıca, açılacak olan 3. Apple mağazası, misafirlere özel bir bahçe imkanı gibi bir olanağa da sahip olacak. <strong>reader</strong> will be
